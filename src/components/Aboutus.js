          ...
          <Container maxWidth="lg">
            <Box >
              ...
              <Grid container spacing={3}>
                ...
                <Grid item md={3}><Person name="Sean Wilson" description="I'm a full-stack web/software engineer working on FoxFiles software. I love to adventure into the unknown, whether that be some new topic or out and about mountain biking. I also like to play a variety of sports including tennis, soccer, badminton, and swimming. Often times, you'll find holed up in FoxFiles HQ working on new updates to our software." role="Founder" image="/assets/images/SWB.jpg"/></Grid>
                <Grid item md={3}><Person name="Damian Pascal" description="My name is Damian Pascal. I have had a variety of customer service opportunities, through which I was able to have fewer returns products and increased repeat customers. People find me to be an upbeat, self-motivated team player with excellent communication skills." role="Founder" image="/assets/images/DP.jpg"/></Grid>
                            </Grid>
            </Box>
          </Container>
        );
